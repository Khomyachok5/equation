...
For CSV file submissions, a aster graph will be displayed, showing an approximate position of each parabola against the others. A separate graph is then generated for each parabola that shows it in closer proximity.
